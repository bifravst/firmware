...
#define CLOUD_CLIENT_PUBLIC_CERTIFICATE                                        \
	"-----BEGIN CERTIFICATE-----\n"	\
	"MIICtDCCAZwCFHCGnzGqGlKy3pDPmh+qOs275T8ZMA0GCSqGSIb3DQEBCwUAMBMx\n"	\
	"ETAPBgNVBAsMCGJpZnJhdnN0MB4XDTE5MDcyOTExNDI0MloXDTQ5MDcyMTExNDI0\n"	\
	"MlowGjEYMBYGA1UEAwwPMzUyNjU2MTAwMjQ3ODE5MIIBIjANBgkqhkiG9w0BAQEF\n"	\
	"AAOCAQ8AMIIBCgKCAQEAzh00E6LPVsI538/IGaQj1by7kSvH1Hong8lgM9fMe1ge\n"	\
	"gA2PiC65aARsNGq/yz9DUDWFO2yf1Jz4eyNgjQFBs4Jghb+mrGXns8XISahLWOLY\n"	\
	"mMqexMwnm2fqR9a9kBiNfjQXDFiw3jidzSauUIWSXmuk3BJHBRgtQ0nPB1p7B/Ve\n"	\
	"UhfntV2yys5wIfZEv7NHv/EsCZQMsnC6U/nojyQ4EUtb2g5jHka8R+DyHN83thIy\n"	\
	"pL6f6TUwq7MbCfThDK+1FVPJweIpVROUezCprrZDbN6BbVHLpbrel8IOS1Ns9qpE\n"	\
	"+wizPJbtOhTpIjegCyqgUf+5gXNZOqysyo2Ks7VgpQIDAQABMA0GCSqGSIb3DQEB\n"	\
	"CwUAA4IBAQA96kZ9HMK9huLlZSsVaqv/yiJiT2FwprccGZItrnSDdt3LLxz5PFBE\n"	\
	"QsdbHciGGEAFaCGf0Bhj2kCGWLjm+Wu8FLbwmkvXG5bbWQ/08+U2pzxLqpv/VyKw\n"	\
	"iFZVKjdgfgQMO6VSSnQ8RLiyQtN/GnbrnEkR4tKfMEpf/XyqIteR5KKz4yYIwE7F\n"	\
	"MZqJTGz0e8nSr3kRvc4BjHnsNOOIn/n5MD4ZlliMLHLoh8mFyCpdYxfU5BxADjYF\n"	\
	"62fVuWKYcO8doj7E0z70n/grzZPYkHzAN3ClKQ+StqsXWqXKEseZb6n1oboxluIu\n"	\
	"GdVs1s4Mx7NktD1+VkynyXK7E5Mh5aGf\n"	\
	"-----END CERTIFICATE-----\n"	\
	"-----BEGIN CERTIFICATE-----\n"	\
