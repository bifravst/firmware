...
#ifdef DT_GPIO_LEDS_LED_1_GPIO_PIN
	{
		DT_GPIO_LEDS_LED_1_GPIO_CONTROLLER,
		DT_GPIO_LEDS_LED_1_GPIO_PIN,
	},
#endif
#ifdef DT_GPIO_LEDS_LED_2_GPIO_PIN
	{
		DT_GPIO_LEDS_LED_2_GPIO_CONTROLLER,
		DT_GPIO_LEDS_LED_2_GPIO_PIN,
	},
#endif
#ifdef DT_GPIO_LEDS_LED_3_GPIO_PIN
	{
		DT_GPIO_LEDS_LED_3_GPIO_CONTROLLER,
		DT_GPIO_LEDS_LED_3_GPIO_PIN,
	},
#endif
};
